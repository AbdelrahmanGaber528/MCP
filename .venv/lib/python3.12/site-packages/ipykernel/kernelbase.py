...
class Kernel(SingletonConfigurable):
    ...
    # Asyncio lock to ensure only one control queue message is process at a time.
    ...
    async def dispatch_control(self, msg):
        # Ensure only one control message is process at a time
    ...
    def enter_eventloop(self):
        ...
        def schedule_next():
            ...
            # are process before we enter the eventloop, even if the previous dispatch was
    ...
    async def process_one(self, wait=True):
        ...
        if self.control_thread is None and self.control_stream is not None:
            ...
            # messages and allow them all to be process.
