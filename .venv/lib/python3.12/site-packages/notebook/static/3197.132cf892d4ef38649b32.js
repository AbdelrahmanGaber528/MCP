...
class LangiumParser extends AbstractLangiumParser {
     ...
     *
     * 1. They were inserted during error recovery by the parser. These tokens don't really exist and should not be further process
...
(function (DocumentState) {
    ...
    /**
     * The `IndexManager` service has process AST nodes of this document. This means the
     * exported symbols are available in the global scope and can be resolved from other documents.
     */
    DocumentState[DocumentState["IndexedContent"] = 2] = "IndexedContent";
    /**
     * The `ScopeComputation` service has process this document. This means the local symbols
    ...
    /**
     * The `Linker` service has process this document. All outgoing references have been
     * resolved or marked as erroneous.
     */
    DocumentState[DocumentState["Linked"] = 4] = "Linked";
    /**
     * The `IndexManager` service has process AST node references of this document. This is
     * necessary to determine which documents are affected by a change in one of the workspace
     * documents.
     */
    DocumentState[DocumentState["IndexedReferences"] = 5] = "IndexedReferences";
    /**
     * The `DocumentValidator` service has process this document. The language server listens
...
class DefaultLangiumDocumentFactory {
     ...
     * existing documents are process via {@link update}.
     */
...
class DefaultLinker {
    ...
    createLinkingError(refInfo, targetDescription) {
        // Check whether the document is sufficiently process by the DocumentBuilder. If not, this is a hint for a bug
...
class DefaultDocumentBuilder {
     ...
     * @returns A promise that resolves when all documents have been process or the operation is canceled.
    ...
    async notifyBuildPhase(documents, state, cancelToken) {
        if (documents.length === 0) {
            // Don't notify when no document has been process
            return;
        }
