 ...
 * @param recurseList - The list of recursive references already process
 ...
 *          dependencies as a list of schemas
 * @param [recurseList=[]] - The optional, list of recursive references already process
 ...
 *
 * @param validator - An implementation of the `ValidatorType` interface that will be forwarded to all the APIs
 * @param dependencies - The set of dependencies that needs to be process
 ...
 * the object are process as follows after obtaining the formValue from `formData` using the `key`:
 ...
 *   - Once all keys have been process, return an object built as follows:
