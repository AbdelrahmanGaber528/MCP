...
class EmbeddedSphinxShell:
    ...
    def process_input(self, data, input_prompt, lineno):
        ...
        if not is_suppress and len(rest.strip()) and is_verbatim:
            ...
            # add it, as the new line will be added by the process output.
            ret.append(rest)

        # Fetch the process output. (This is not the submitted output.)
        self.cout.seek(0)
        ...
        if not is_suppress and not is_semicolon:
            ...
            #    In [2]: x = 5
            #
            # When there is process output, it has a '\n' at the tail end. So
    ...
    def process_output(self, data, output_prompt, input_lines, output,
        ...
        """
        # Recall: `data` is the submitted output, and `output` is the process
        ...
        if is_doctest and output is not None:
            ...
            found = output # This is the process output
            found = found.strip()
    ...
    def process_block(self, block):
        """
        process block from the block_parser and return a list of process lines
        """
        ret = []
        output = None
        input_lines = None
...
class IPythonDirective(Directive):
    ...
    def setup(self):
        ...
        # reset the execution count if we haven't process this doc
