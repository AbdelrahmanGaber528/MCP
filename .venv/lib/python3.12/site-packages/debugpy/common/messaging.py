...
class Event(Message):
    ...
    No further incoming messages are process until the handler returns, except for
...
class JsonMessageChannel(object):
    ...
    def start(self):
        ...
        Incoming messages, including responses to requests, will not be process at
    ...
    def _run_handlers(self):
        ...
        while True:
            ...
            for what, handler in handlers:
                ...
                # the corresponding request or event is the last thing to be process.
