...
class BatchCompletionCallBack(object):
    ...
    def _dispatch_new(self):
        """Schedule the next batch of tasks to be process."""
...
class Parallel(Logger):
    ...
    return_as: str in {'list', 'generator', 'generator_unordered'}, default='list'
        ...
        all results have been process and retrieved.
    ...
    * Ability to use shared memory efficiently with worker
    ...
    def _wait_retrieval(self):
        ...
        # If some of the dispatched tasks are still being process by the
    ...
    def _warn_exit_early(self):
        ...
        if not is_completed:
            msg += (
                ...
                "which were still being process by the workers have been "
                "cancelled."
            )
